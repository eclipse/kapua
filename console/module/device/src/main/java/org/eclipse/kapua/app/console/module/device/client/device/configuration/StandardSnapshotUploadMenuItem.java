...
public class StandardSnapshotUploadMenuItem extends KapuaMenuItem {

    private static final ConsoleDeviceMessages MSGS = GWT.create(ConsoleDeviceMessages.class);

    public StandardSnapshotUploadMenuItem(SelectionListener<MenuEvent> listener) {
        super(MSGS.standardButtonSnapshotUpload(),
                IconSet.CLOUD_UPLOAD,
                listener);
    }
}
