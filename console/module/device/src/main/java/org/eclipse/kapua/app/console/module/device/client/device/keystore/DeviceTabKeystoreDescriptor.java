...
public class DeviceTabKeystoreDescriptor extends AbstractEntityTabDescriptor<GwtDevice, DeviceTabKeystore, DeviceView> {

    @Override
    public DeviceTabKeystore getTabViewInstance(DeviceView view, GwtSession currentSession) {
        return new DeviceTabKeystore(currentSession, view);
    }
