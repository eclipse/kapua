...
public class NativeSnapshotUploadMenuItem extends KapuaMenuItem {

    private static final ConsoleDeviceMessages MSGS = GWT.create(ConsoleDeviceMessages.class);

    public NativeSnapshotUploadMenuItem(SelectionListener<MenuEvent> listener) {
        super(MSGS.nativeButtonSnapshotUpload(),
