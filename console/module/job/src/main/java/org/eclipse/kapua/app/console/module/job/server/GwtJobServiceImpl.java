    ...
    public ListLoadResult<GwtGroupedNVPair> findJobDescription(String gwtScopeId,
        ...
        try {
            ...
            if (job != null) {
                ...
                gwtJobDescription.add(new GwtGroupedNVPair("jobInfo", "jobCreatedBy", createdUser != null ? createdUser.getName() : "N/A"));
                gwtJobDescription.add(new GwtGroupedNVPair("jobInfo", "jobModifiedOn", job.getModifiedOn()));
                gwtJobDescription.add(new GwtGroupedNVPair("jobInfo", "jobModifiedBy", modifiedUser != null ? modifiedUser.getName() : "N/A"));
            }
        } catch (Exception e) {
