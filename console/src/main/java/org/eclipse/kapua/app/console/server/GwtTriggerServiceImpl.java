...
import org.eclipse.kapua.app.console.shared.model.job.GwtTriggerCreator;
...
import org.eclipse.kapua.app.console.shared.service.GwtTriggerService;
...
public class GwtTriggerServiceImpl extends KapuaRemoteServiceServlet implements GwtTriggerService {
    ...
    public PagingLoadResult<GwtTrigger> findByJobId(PagingLoadConfig loadConfig, String gwtScopeId, String gwtJobId) throws GwtKapuaException {
        ...
        try {
            ...
            TriggerQuery triggerQuery = GwtKapuaModelConverter.convertTriggetQuery(gwtTriggerQuery, loadConfig);
            ...
            if (!triggerListResult.isEmpty()) {
                ...
                for (Trigger trigger : triggerListResult.getItems()) {
                    gwtTriggerList.add(KapuaGwtModelConverter.convertTrigger(trigger));
                }
            }
    ...
    public GwtTrigger create(GwtXSRFToken xsrfToken, GwtTriggerCreator gwtTriggerCreator) throws GwtKapuaException {
        ...
        try {
            ...
            triggerCreator.setTriggerProperties(GwtKapuaModelConverter.convertTriggerProperties(gwtTriggerCreator.getTriggerProperties()));
            ...
            gwtTrigger = KapuaGwtModelConverter.convertTrigger(trigger);
        } catch (Throwable t) {
            KapuaExceptionHandler.handle(t);
        }
    ...
    public GwtTrigger update(GwtXSRFToken xsrfToken, GwtTrigger gwtTrigger) throws GwtKapuaException {
        ...
        try {
            ...
            if (trigger != null) {
                ...
                // update the trigger
                gwtTriggerUpdated = KapuaGwtModelConverter.convertTrigger(triggerService.update(trigger));
            }
        } catch (Throwable t) {
            KapuaExceptionHandler.handle(t);
        }
    ...
    public void delete(GwtXSRFToken xsrfToken, String gwtScopeId, String gwtTriggerId) throws GwtKapuaException {
        ...
        KapuaId triggerId = GwtKapuaModelConverter.convert(gwtTriggerId);
