 ...
 *******************************************************************************/
package org.eclipse.kapua.app.console.client.job.steps;
...
import org.eclipse.kapua.app.console.shared.service.GwtJobStepDefinitionServiceAsync;
import org.eclipse.kapua.app.console.shared.service.GwtJobStepService;
import org.eclipse.kapua.app.console.shared.service.GwtJobStepServiceAsync;
...
public class JobStepAddDialog extends EntityAddEditDialog {
    ...
    public void createBody() {
        ...
        RpcProxy<ListLoadResult<GwtJobStepDefinition>> jobStepDefinitionProxy = new RpcProxy<ListLoadResult<GwtJobStepDefinition>>() {
            ...
            protected void load(Object loadConfig, AsyncCallback<ListLoadResult<GwtJobStepDefinition>> callback) {
                JOB_STEP_DEFINITION_SERVICE.findAll(currentSession.getSelectedAccount().getId(),
                        callback);
            }
        };
    ...
    public void submit() {
        ...
        gwtJobStepCreator.setScopeId(currentSession.getSelectedAccount().getId());
    ...
    private void refreshJobStepDefinition(GwtJobStepDefinition gwtJobStepDefinition) {
        ...
        for (GwtJobStepProperty property : gwtJobStepDefinition.getStepProperties()) {
            ...
            if (
                ...
                textField.setEmptyText(property.getPropertyValue());
                ...
                textArea.setEmptyText(property.getPropertyValue());
    ...
    protected void onRender(Element parent, int pos) {
        ...
        JOB_STEP_SERVICE.getFirstFreeStepIndex(currentSession.getSelectedAccount().getId(), jobId, new AsyncCallback<Integer>() {
