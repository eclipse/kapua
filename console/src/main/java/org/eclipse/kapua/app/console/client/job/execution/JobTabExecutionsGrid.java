 ...
 *******************************************************************************/
package org.eclipse.kapua.app.console.client.job.execution;
...
import org.eclipse.kapua.app.console.shared.service.GwtExecutionService;
import org.eclipse.kapua.app.console.shared.service.GwtExecutionServiceAsync;
...
public class JobTabExecutionsGrid extends EntityGrid<GwtExecution> {
    ...
    public JobTabExecutionsGrid(EntityView<GwtExecution> entityView, GwtSession currentSession) {
    ...
    protected RpcProxy<PagingLoadResult<GwtExecution>> getDataProxy() {
        return new RpcProxy<PagingLoadResult<GwtExecution>>() {
            ...
            protected void load(Object o, AsyncCallback<PagingLoadResult<GwtExecution>> asyncCallback) {
                EXECUTION_SERVICE.findByJobId((PagingLoadConfig)o, currentSession.getSelectedAccount().getId(), jobId, asyncCallback);
            }
        };
    }
