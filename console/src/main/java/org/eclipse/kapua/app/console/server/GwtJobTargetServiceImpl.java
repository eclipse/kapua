...
import org.eclipse.kapua.app.console.shared.model.job.GwtJobTargetCreator;
import org.eclipse.kapua.app.console.shared.model.job.GwtJobTargetQuery;
import org.eclipse.kapua.app.console.shared.service.GwtJobTargetService;
...
public class GwtJobTargetServiceImpl extends KapuaRemoteServiceServlet implements GwtJobTargetService {
    ...
    public PagingLoadResult<GwtJobTarget> query(PagingLoadConfig loadConfig, GwtJobTargetQuery gwtJobTargetQuery) throws GwtKapuaException {
        ...
        try {
            ...
            JobTargetQuery jobTargetQuery = GwtKapuaModelConverter.convertJobTargetQuery(gwtJobTargetQuery, loadConfig);
            ...
            if (!jobTargetList.isEmpty()) {
                ...
                for (JobTarget jt : jobTargetList.getItems()) {
                    gwtJobTargetList.add(KapuaGwtModelConverter.convertJobTarget(jt));
                }
            }
    ...
    public List<GwtJobTarget> create(GwtXSRFToken xsrfToken, List<GwtJobTargetCreator> gwtJobTargetCreatorList) throws GwtKapuaException {
        ...
        try {
            ...
            for (GwtJobTargetCreator gwtJobTargetCreator : gwtJobTargetCreatorList) {
                ...
                jobTargetCreator.setJobId(GwtKapuaModelConverter.convert(gwtJobTargetCreator.getJobId()));
                jobTargetCreator.setJobTargetId(GwtKapuaModelConverter.convert(gwtJobTargetCreator.getJobTargetId()));
                ...
                gwtJobTargetList.add(KapuaGwtModelConverter.convertJobTarget(jobTarget));
            }
        } catch (Throwable t) {
            KapuaExceptionHandler.handle(t);
        }
    ...
    public void delete(GwtXSRFToken xsrfToken, String gwtScopeId, String gwtJobTargetId) throws GwtKapuaException {
        ...
        KapuaId jobTargetId = GwtKapuaModelConverter.convert(gwtJobTargetId);
