...
import org.eclipse.kapua.app.console.client.util.BeforeDateValidator;
...
import org.eclipse.kapua.app.console.shared.service.GwtTriggerServiceAsync;
...
public class JobScheduleAddDialog extends EntityAddEditDialog {
    ...
    public void submit() {
        ...
        gwtTriggerCreator.setScopeId(currentSession.getSelectedAccount().getId());
