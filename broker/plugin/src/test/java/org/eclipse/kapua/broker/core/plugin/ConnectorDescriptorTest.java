...
public class ConnectorDescriptorTest {
    ...
    public void testDefault3() {
        final Map<String, String> properties = new HashMap<>();
        properties.put(BrokerPluginSettingKey.CONFIGURATION_URI.key(), "file:src/test/resources/does-not-exist.properties");
    ...
    public void testDefault4() {
        final Map<String, String> properties = new HashMap<>();
        properties.put(BrokerPluginSettingKey.CONFIGURATION_URI.key(), "file:src/test/resources/conector.descriptor/1.properties");
    ...
    public void testDefault7() {
        final Map<String, String> properties = new HashMap<>();
        properties.put(BrokerPluginSettingKey.DISABLE_DEFAULT_CONNECTOR_DESCRIPTOR.key(), "true");
        properties.put(BrokerPluginSettingKey.CONFIGURATION_URI.key(), "file:src/test/resources/conector.descriptor/3.properties");
    ...
    public void testConfig1() {
        final Map<String, String> properties = new HashMap<>();
        properties.put(BrokerPluginSettingKey.CONFIGURATION_URI.key(), "");
    ...
    public void testBrokerIpOrHostNameConfigFile() throws Exception {
        ...
        System.setProperty("kapua.config.url", "broker.setting/kapua-broker-core-setting-1.properties");
    ...
    public void testBrokerIpOrHostNameEmptyConfigFile() throws Exception {
        System.clearProperty("broker.ip");
        System.setProperty("kapua.config.url", "broker.setting/kapua-broker-core-setting-2.properties");
    ...
    public void testBrokerIpOrHostNameNoEnvProperty() throws Exception {
        System.clearProperty("broker.ip");
        System.setProperty("kapua.config.url", "broker.setting/kapua-broker-core-setting-3.properties");
