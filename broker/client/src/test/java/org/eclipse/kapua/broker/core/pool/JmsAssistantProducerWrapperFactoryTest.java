...
import org.eclipse.kapua.broker.client.pool.JmsAssistantProducerWrapperFactory;
...
public class JmsAssistantProducerWrapperFactoryTest {
    ...
    public void wrapTest() {
        for (String destination : destinations) {
            ...
            Assert.assertEquals("Expected and actual values should be the same.", PooledObjectState.IDLE, wrapperFactory.wrap(producerWrapper).getState());
            Assert.assertTrue("True expected.", wrapperFactory.wrap(producerWrapper) instanceof PooledObject);
        }
    }
    ...
    public void wrapNullTest() {
        for (String destination : destinations) {
            JmsAssistantProducerWrapperFactory wrapperFactory = new JmsAssistantProducerWrapperFactory(destination);
            Assert.assertEquals("Expected and actual values should be the same.", PooledObjectState.IDLE, wrapperFactory.wrap(null).getState());
            Assert.assertTrue("True expected.", wrapperFactory.wrap(null) instanceof PooledObject);
        }
    }
    ...
    public void validateObjectTest() throws KapuaException, JMSException {
        ...
        Assert.assertTrue("True expected.", wrapperFactory.validateObject(pooledProducerWrapper));
    }
    ...
    public void validateObjectActiveMQSessionFalseTest() throws KapuaException, JMSException {
        ...
        Assert.assertFalse("False expected.", wrapperFactory.validateObject(pooledProducerWrapper));
    }
