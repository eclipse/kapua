...
import org.eclipse.kapua.broker.client.pool.JmsProducerWrapper;
...
public class JmsProducerWrapperTest {
    ...
    public void getDestinationTest() throws KapuaException, JMSException {
        for (boolean transactedValue : transacted) {
            for (boolean startValue : start) {
                ...
                Assert.assertEquals("Expected and actual values should be the same.", "Destination", jmsProducerWrapper.getDestination());
            }
        }
    }
