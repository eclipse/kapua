...
public class CamelKapuaMessage<M extends KapuaMessage<?, ?>> implements Serializable {
     ...
     */
    public CamelKapuaMessage(M message, KapuaId connectionId, ProtocolDescriptor connectorDescriptor) {
    ...
    public void setConnectorDescriptor(ProtocolDescriptor connectorDescriptor) {
        this.connectorDescriptor = connectorDescriptor;
    }
