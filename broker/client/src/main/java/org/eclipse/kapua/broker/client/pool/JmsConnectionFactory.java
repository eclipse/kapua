...
public class JmsConnectionFactory {
    ...
    static {
        ...
        String connectionFactoryUri = String.format("vm://%s?create=false&waitForStart=3600000&async=true", BrokerClientSetting.getInstance().getString(BrokerClientSettingKey.BROKER_NAME));
