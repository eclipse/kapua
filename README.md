...
Suppose the target is the current snapshot 2.1.0-EVENTCLIENTS-SNAPSHOT.
...
that the following step will pull proper images from the Docker Hub. If, on the other hand, your target is a SNAPSHOT version (for example, the 2.1.0-EVENTCLIENTS-SNAPSHOT), a local build is required
