...
Suppose the target is the current snapshot 2.0.0-BETA-M2.
...
that the following step will pull proper images from the Docker Hub. If, on the other hand, your target is a SNAPSHOT version (for example, the 2.0.0-BETA-M2), a local build is required
