...
public class HonoLifecycleProcessorVerticle extends AbstractMessageProcessorVerticle implements MessageProcessorVerticle {

    @Inject
    private HonoLifecycleProcessorConfigFactory configFactory;

    private HonoLifecycleProcessor messageProcessor;
    ...
    public void internalStart(Future<Void> startFuture) throws Exception {
        ...
        messageProcessor = HonoLifecycleProcessor.create(vertx, config); 
