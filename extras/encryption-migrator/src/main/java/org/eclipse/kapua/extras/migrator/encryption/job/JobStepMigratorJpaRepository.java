...
public class JobStepMigratorJpaRepository
    ...
    @Override
    public JobStep find(TxContext tx,KapuaId scopeId, KapuaId entityId) throws KapuaException {
    ...
    @Override
    public JobStep findByName(TxContext tx,String name) throws KapuaException {
        throw new UnsupportedOperationException();
    }

    @Override
    public JobStep findByName(TxContext tx,KapuaId scopeId, String name) throws KapuaException {
        throw new UnsupportedOperationException();
    }
}
