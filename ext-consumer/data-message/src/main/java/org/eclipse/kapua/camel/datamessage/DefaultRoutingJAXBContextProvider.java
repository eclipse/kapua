...
public class DefaultRoutingJAXBContextProvider implements JAXBContextProvider {

    private static Logger logger = LoggerFactory.getLogger(DefaultRoutingJAXBContextProvider.class);
