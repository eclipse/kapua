...
public class DockerSteps {
     ...
     * @param dockerImage              full name of image (e.g. "kapua/kapua-broker:1.6.13-SNAPSHOT")
    ...
    private ContainerConfig getDbContainerConfig() {
        ...
        return ContainerConfig.builder()
                ...
                .image("kapua/kapua-sql:1.6.13-SNAPSHOT")
                .build();
    }
    ...
    private ContainerConfig getEventBrokerContainerConfig() {
        ...
        return ContainerConfig.builder()
                ...
                .image("kapua/kapua-events-broker:1.6.13-SNAPSHOT")
                .build();
    }
