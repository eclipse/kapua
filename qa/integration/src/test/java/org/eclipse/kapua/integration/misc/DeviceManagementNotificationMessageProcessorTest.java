...
public class DeviceManagementNotificationMessageProcessorTest {
    ...
    public void initialize() {
        final DeviceManagementRegistryManagerService deviceManagementRegistryManagerService = KapuaLocator.getInstance().getService(DeviceManagementRegistryManagerService.class);
        final JobDeviceManagementOperationManagerService jobDeviceManagementOperationManagerService = KapuaLocator.getInstance().getService(JobDeviceManagementOperationManagerService.class);
        deviceManagementNotificationMessageProcessor = new DeviceManagementNotificationMessageProcessor(deviceManagementRegistryManagerService, jobDeviceManagementOperationManagerService);
