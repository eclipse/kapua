...
Feature: Testing docker steps
  ...
  Scenario: Execute possible docker steps to show its usage
    ...
    Given List images by name "kapua/kapua-broker:1.6.5-SNAPSHOT"
    #And Pull image "kapua/kapua-sql:1.6.5-SNAPSHOT"
    ...
    And Start Message Broker container
      ...
      | broker-1 | broker1         | 0.0.0.0  | test-cluster | 1883     | 1883         | 8883      | 8883          | 8161    | 8161        | 9999      | 9999          | 9991                   | kapua/kapua-broker:1.6.5-SNAPSHOT |
    And Start Message Broker container
      | name     | brokerAddress  | brokerIp | clusterName  | mqttPort | mqttHostPort | mqttsPort | mqttsHostPort | webPort | webHostPort | debugPort | debugHostPort | brokerInternalDebugPort| dockerImage |
      | broker-2 | broker2        | 0.0.0.0  | test-cluster | 1883     | 1884         | 8883      | 8884          | 8161    | 8162        | 9999      | 9998          | 9991                   | kapua/kapua-broker:1.6.5-SNAPSHOT |
