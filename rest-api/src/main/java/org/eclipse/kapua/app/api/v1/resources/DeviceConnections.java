...
//    /**
//     * Creates a new DeviceConnection based on the information provided in DeviceConnectionCreator
//     * parameter.
//     *
//     * @param deviceConnectionCreator
//     *            Provides the information for the new DeviceConnection to be created.
//     * @return The newly created DeviceConnection object.
//     */
//    @ApiOperation(value = "Create an DeviceConnection", notes = "Creates a new DeviceConnection based on the information provided in DeviceConnectionCreator parameter.", response = DeviceConnection.class)
//    @POST
//    @Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
//    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
//    public DeviceConnection create(@PathParam("scopeId") ScopeId scopeId,
//            @ApiParam(value = "Provides the information for the new DeviceConnection to be created", required = true) DeviceConnectionCreator deviceConnectionCreator) {
//        DeviceConnection deviceConnection = null;
//        try {
//            deviceConnectionCreator.setScopeId(scopeId);
...
//    /**
//     * Updates the DeviceConnection based on the information provided in the DeviceConnection parameter.
//     *
//     * @param deviceConnection
//     *            The modified DeviceConnection whose attributed need to be updated.
//     * @return The updated deviceConnection.
//     */
//    @ApiOperation(value = "Update an DeviceConnection", notes = "Updates a new DeviceConnection based on the information provided in the DeviceConnection parameter.", response = DeviceConnection.class)
//    @PUT
//    @Path("{deviceConnectionId}")
//    @Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
//    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
//    public DeviceConnection update(@PathParam("scopeId") ScopeId scopeId,
//            @PathParam("deviceConnectionId") EntityId deviceConnectionId,
//            @ApiParam(value = "The modified DeviceConnection whose attributed need to be updated", required = true) DeviceConnection deviceConnection) {
//        DeviceConnection deviceConnectionUpdated = null;
//        try {
//            ((DeviceConnectionImpl) deviceConnection).setScopeId(scopeId);
//            deviceConnection.setId(deviceConnectionId);
//
//            deviceConnectionUpdated = deviceConnectionService.update(deviceConnection);
//        } catch (Throwable t) {
//            handleException(t);
//        }
//        return returnNotNullEntity(deviceConnectionUpdated);
//    }

//    /**
//     * Deletes the DeviceConnection specified by the "deviceConnectionId" path parameter.
//     *
//     * @param deviceConnectionId
//     *            The id of the DeviceConnection to be deleted.
//     * @return HTTP 200 if operation has completed successfully.
//     */
//    @ApiOperation(value = "Delete an DeviceConnection", notes = "Deletes the DeviceConnection specified by the \"deviceConnectionId\" path parameter.")
//    @DELETE
//    @Path("{deviceConnectionId}")
//    public Response deleteDeviceConnection(@PathParam("scopeId") ScopeId scopeId,
//            @ApiParam(value = "The id of the DeviceConnection to be deleted", required = true) @PathParam("deviceConnectionId") EntityId deviceConnectionId) {
//        try {
//            deviceConnectionService.delete(scopeId, deviceConnectionId);
//        } catch (Throwable t) {
//            handleException(t);
//        }
