...
public class CurrentAccount extends AbstractKapuaResource {
     ...
     *
     * @param account The modified Account whose attributed need to be updated (ScopeId and Id will be ignored and superseded by the ones from the current session)
    ...
    public Account update(AccountService.CurrentAccountUpdateRequest request) throws KapuaException {
