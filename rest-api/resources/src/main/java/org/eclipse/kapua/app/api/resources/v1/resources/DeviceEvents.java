...
public class DeviceEvents extends AbstractKapuaResource {
    ...
    public DeviceEventListResult simpleQuery(
        ...
        andPredicate.and(new AttributePredicateImpl<>(DeviceEventAttributes.DEVICE_ID, deviceId));
        if (!Strings.isNullOrEmpty(resource)) {
            andPredicate.and(new AttributePredicateImpl<>(DeviceEventAttributes.RESOURCE, resource));
        }
    ...
    public CountResult count(
        ...
        query.setScopeId(scopeId);
        query.setPredicate(new AttributePredicateImpl<>(DeviceEventAttributes.DEVICE_ID, deviceId));
    ...
    public DeviceEvent find(
        ...
        AndPredicateImpl andPredicate = new AndPredicateImpl();
        andPredicate.and(new AttributePredicateImpl<>(DeviceEventAttributes.DEVICE_ID, deviceId));
        andPredicate.and(new AttributePredicateImpl<>(KapuaEntityAttributes.ENTITY_ID, deviceEventId));
