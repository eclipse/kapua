...
/**
 * {@link KapuaEntityBareRepository} utility methods.
 *
 * @since 1.0.0
 */
public interface KapuaEntityBareRepository<E extends KapuaEntity, L extends KapuaListResult<E>> {
    ...
    E doDelete(TxContext txContext, E entityToDelete);
}
