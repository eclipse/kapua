...
public class ServiceXmlConfigPropertyAdapted implements XmlPropertyAdapted<ServiceXmlConfigPropertyAdapted.ConfigPropertyType> {
...
//        @XmlEnumValue("Password")passwordType
    ...
    public ServiceXmlConfigPropertyAdapted(String name,
