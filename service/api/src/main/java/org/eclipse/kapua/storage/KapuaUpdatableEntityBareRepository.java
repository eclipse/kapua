...
public interface KapuaUpdatableEntityBareRepository<E extends KapuaUpdatableEntity, L extends KapuaListResult<E>> extends KapuaEntityBareRepository<E, L> {
    /**
    ...
    E doUpdate(TxContext txContext, E currentEntity, E updatedEntity) throws KapuaException;
}
