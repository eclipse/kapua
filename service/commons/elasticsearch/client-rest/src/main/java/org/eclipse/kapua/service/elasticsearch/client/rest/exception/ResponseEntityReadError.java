...
/**
 * {@link ClientInternalError} to {@code throw} when there is an error on {@link com.fasterxml.jackson.databind.ObjectMapper#readTree(String)}}
 *
 * @since 1.3.0
 */
public class ResponseEntityReadError extends ClientInternalError {
     ...
     * @since 1.3.0
     */
    public ResponseEntityReadError(Throwable cause) {
        super(cause, "Error managing ObjectMapper.read");
    }
}
