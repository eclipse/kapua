...
/**
 * Service setting implementation.<br>
 * This class handles settings for the {@link ServiceSettingKey}.
 */
public final class ServiceSetting extends AbstractKapuaSetting<ServiceSettingKey> {

    private static final String CONFIG_RESOURCE_NAME = "kapua-service-camel-setting.properties";
