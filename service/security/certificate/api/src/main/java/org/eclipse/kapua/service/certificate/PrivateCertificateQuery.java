...
@XmlType(factoryClass = PrivateCertificateXmlRegistry.class, factoryMethod = "newQuery")
public interface PrivateCertificateQuery extends KapuaQuery<PrivateCertificate> {
