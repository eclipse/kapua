...
public class PasswordValidatorImpl implements PasswordValidator {
    ...
    public int getMinimumPasswordLength(KapuaId scopeId) throws KapuaException {
        ...
        Object minPasswordLengthConfigValue = getConfigValues(scopeId).get(CredentialServiceConfigurationManagerImpl.PASSWORD_MIN_LENGTH_ACCOUNT_CONFIG_KEY);

        if (!KapuaId.ANY.equals(scopeId)) {
            Object minPasswordLengthAccountConfigValue = getConfigValues(scopeId).get(minPasswordLengthConfigValue);
