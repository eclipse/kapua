...
public class KapuaPasswordTooShortException extends KapuaException {
    ...
    private static final String MESSAGE_FORMAT = "The specified password %s doesn't meet the required minimum length: %s.";

    /**
     * Constructor for the {@link KapuaPasswordTooShortException} taking in the duplicated name.
     */
    public KapuaPasswordTooShortException(String password, int length) {
        super(KapuaAuthenticationErrorCodes.PASSWORD_CANNOT_BE_CHANGED, String.format(MESSAGE_FORMAT, password, length));
    }
