...
public class DatastoreTarget implements MessageTarget<TransportMessage> {
    ...
    public void process(MessageContext<TransportMessage> message, Handler<AsyncResult<Void>> result) {
        ...
        KapuaDataMessage kapuaDataMessage = kapuaMessageFactory.newKapuaDataMessage();

        //channel
        KapuaDataChannel kapuaChannel = kapuaMessageFactory.newKapuaDataChannel();
        kapuaChannel.setSemanticParts(tm.getChannel().getSemanticParts());

        //payload
        KapuaDataPayload kapuaPayload = kapuaMessageFactory.newKapuaDataPayload();
