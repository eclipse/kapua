...
public class MetricPredicateImpl extends RangePredicateImpl implements MetricPredicate {
     ...
     * Default constructor
     */
    public MetricPredicateImpl() {
    }

    public <V extends Comparable<V>> MetricPredicateImpl(StorableField field, V minValue, V maxValue) {
     ...
     * @param maxValue
     */
    public <V extends Comparable<V>> MetricPredicateImpl(String field, V minValue, V maxValue) {
        this.field = field;
