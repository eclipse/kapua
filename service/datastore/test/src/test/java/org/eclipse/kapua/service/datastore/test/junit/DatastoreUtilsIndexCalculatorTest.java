...
public class DatastoreUtilsIndexCalculatorTest {
    ...
    private void performTest(Date startDate, Date endDate, String[] expectedIndexes) throws DatastoreException {
        ...
        String[] index = datastoreUtils.filterIndexesTemporalWindow(getDataIndexesByAccount(KapuaEid.ONE), startDate != null ? startDate.toInstant() : null,
                endDate != null ? endDate.toInstant() : null, null);
