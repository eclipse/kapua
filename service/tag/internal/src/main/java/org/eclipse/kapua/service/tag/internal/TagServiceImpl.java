...
public class TagServiceImpl extends AbstractKapuaConfigurableResourceLimitedService<Tag, TagCreator, TagService, TagListResult, TagQuery, TagFactory> implements TagService {
    ...
    public Tag create(TagCreator tagCreator)
        ...
        if(findByName(tagCreator.getName()) != null) {
            throw new KapuaDuplicateNameInAnotherAccountError(tagCreator.getName());
        }
        //
        // Check Access
    ...
    @Override
    public Tag findByName(final String name) throws KapuaException {
        ...
        return entityManagerSession.onResult(em -> TagDAO.findByName(em, name));
    }
