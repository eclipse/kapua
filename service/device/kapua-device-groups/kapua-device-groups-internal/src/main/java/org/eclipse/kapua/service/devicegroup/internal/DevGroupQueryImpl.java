...
public class DevGroupQueryImpl extends AbstractKapuaQuery<DeviceGroup> implements DevGroupQuery {

    private DevGroupQueryImpl() {
        super();
    }

    public DevGroupQueryImpl(KapuaId scopeId) {
        this();
        setScopeId(scopeId);
    }
}
