...
public class DeviceManagementOperationNotificationImpl extends AbstractKapuaEntity implements DeviceManagementOperationNotification {
    ...
    private DeviceManagementOperationNotificationImpl() {
        super();
    }

    public DeviceManagementOperationNotificationImpl(KapuaId scopeId) {
        super(scopeId);
    }
