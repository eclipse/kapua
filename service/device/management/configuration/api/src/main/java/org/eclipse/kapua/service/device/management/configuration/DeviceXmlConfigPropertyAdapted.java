...
public class DeviceXmlConfigPropertyAdapted extends XmlPropertyAdapted<DeviceXmlConfigPropertyAdapted.ConfigPropertyType> {
    ...
    public DeviceXmlConfigPropertyAdapted(String name, ConfigPropertyType type, String[] values) {
