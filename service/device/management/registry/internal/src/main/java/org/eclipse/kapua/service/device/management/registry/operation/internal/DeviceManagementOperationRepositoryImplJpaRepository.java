...
public class DeviceManagementOperationRepositoryImplJpaRepository
        extends KapuaUpdatableEntityRepositoryJpaImpl<DeviceManagementOperation, DeviceManagementOperationImpl, DeviceManagementOperationListResult>
        implements DeviceManagementOperationRepository {
    public DeviceManagementOperationRepositoryImplJpaRepository(Supplier<DeviceManagementOperationListResult> listSupplier, EntityManagerSession entityManagerSession) {
