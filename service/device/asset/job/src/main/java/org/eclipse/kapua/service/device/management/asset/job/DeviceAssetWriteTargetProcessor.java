...
public class DeviceAssetWriteTargetProcessor extends AbstractTargetProcessor implements TargetOperation {
    ...
    public void processTarget(JobTarget jobTarget) throws KapuaException {
        ...
        DeviceAssets assets = kapuaStepContext.getStepProperty(DeviceAssetWritePropertyKeys.ASSETS, DeviceAssets.class);
        Long timeout = kapuaStepContext.getStepProperty(DeviceAssetWritePropertyKeys.TIMEOUT, Long.class);
