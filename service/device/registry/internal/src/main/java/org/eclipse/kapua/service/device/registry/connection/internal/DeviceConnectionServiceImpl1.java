 ...
 */
@KapuaProvider
public class DeviceConnectionServiceImpl1 extends
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DeviceConnectionServiceImpl1.class);

    private static final Domain DEVICE_CONNECTION_DOMAIN = new DeviceConnectionDomain();

    public DeviceConnectionServiceImpl1() {
        this(DeviceEntityManagerFactory.instance());
    }

    public DeviceConnectionServiceImpl1(DeviceEntityManagerFactory deviceEntityManagerFactory) {
