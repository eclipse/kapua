...
public class DeviceImplJpaTransactedRepository
        extends KapuaUpdatableEntityJpaTransactedRepository<Device, DeviceImpl, DeviceListResult>
        implements DeviceTransactedRepository {
    public DeviceImplJpaTransactedRepository(Supplier<DeviceListResult> listProvider, EntityManagerSession entityManagerSession) {
