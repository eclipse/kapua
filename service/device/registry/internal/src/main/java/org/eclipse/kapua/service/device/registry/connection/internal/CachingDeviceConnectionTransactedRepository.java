...
public class CachingDeviceConnectionTransactedRepository
        extends KapuaUpdatableEntityTransactedRepositoryCachingWrapper<DeviceConnection, DeviceConnectionListResult>
        implements DeviceConnectionTransactedRepository {

    public CachingDeviceConnectionTransactedRepository(DeviceConnectionTransactedRepository wrapped, EntityCache entityCache) {
