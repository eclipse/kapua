...
public class SecurityMetrics {
    ...
    public static final String METRIC_SUCCESS_FROM_CACHE = "success_from_cache";
    ...
    public static final String METRIC_DISCONNECT_BY_EVENT = METRIC_DISCONNECT + "_by_event";
