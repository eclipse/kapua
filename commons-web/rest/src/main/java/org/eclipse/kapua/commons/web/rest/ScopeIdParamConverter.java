...
import org.eclipse.kapua.commons.web.rest.errors.SessionNotPopulatedException;
...
public class ScopeIdParamConverter implements ParamConverter<ScopeId> {
    ...
    private static final String SCOPE_ID_WILDCARD = KapuaLocator.getInstance().getComponent(KapuaCommonApiCoreSetting.class)
            .getString(KapuaCommonApiCoreSettingKeys.API_PATH_PARAM_SCOPEID_WILDCARD);
