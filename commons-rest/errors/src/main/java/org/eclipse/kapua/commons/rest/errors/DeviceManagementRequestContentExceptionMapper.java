...
public class DeviceManagementRequestContentExceptionMapper implements ExceptionMapper<DeviceManagementRequestContentException> {
    ...
    @Inject
    public DeviceManagementRequestContentExceptionMapper(ExceptionConfigurationProvider exceptionConfigurationProvider) {
    ...
    public Response toResponse(DeviceManagementRequestContentException managementRequestContentException) {
        ...
        return Response
                ...
                .entity(new DeviceManagementRequestContentExceptionInfo(managementRequestContentException, showStackTrace))
                .build();
    }
