...
public class DeviceManagementResponseContentExceptionMapper implements ExceptionMapper<DeviceManagementResponseContentException> {
    ...
    @Inject
    public DeviceManagementResponseContentExceptionMapper(ExceptionConfigurationProvider exceptionConfigurationProvider) {
    ...
    public Response toResponse(DeviceManagementResponseContentException deviceManagementResponseContentException) {
        ...
        return Response
                ...
                .entity(new DeviceManagementResponseContentExceptionInfo(deviceManagementResponseContentException, showStackTrace))
                .build();
    }
