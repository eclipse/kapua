 ...
 * @since 1.0
 */
public class KapuaServiceSchemaUtilsWithResources {

    private static final Logger logger = LoggerFactory.getLogger(KapuaServiceSchemaUtilsWithResources.class);

    private KapuaServiceSchemaUtilsWithResources() {
    }
