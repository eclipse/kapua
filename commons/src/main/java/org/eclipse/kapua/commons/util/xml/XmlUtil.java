...
public class XmlUtil {
     ...
     */
    @Inject
    public XmlUtil(JAXBContextProvider jaxbContextProvider) {
        this.jaxbContextProvider = jaxbContextProvider;
    }

    private final JAXBContextProvider jaxbContextProvider;
     ...
     * @throws KapuaIllegalStateException
     *         if {@link JAXBContextProvider} is not configured.
     * @since 2.0.0
     */
    public JAXBContextProvider getContextProvider() {
     ...
     *         See {@link JAXBContextFactory#createContext(Class[], Map)}
     * @since 1.0.0
     */
     ...
     *
     * @param object
     *         The {@link Object} to marshal.
     * @return The Json {@link String} representation of the object.
     * @throws JAXBException
     *         See {@link Marshaller#marshal(Object, Writer)}.
     * @since 1.0.0
     */
    public String marshal(@NotNull Object object)
            throws JAXBException {
     ...
     * @since 1.0.0
     */
    public void marshal(@NotNull Object object, @NotNull Writer writer)
            throws JAXBException {
     ...
     * @since 1.0.0
     */
    public String marshalJson(@NotNull Object object)
            throws JAXBException {
        try (StringWriter sw = new StringWriter()) {
     ...
     * @since 1.0.0
     */
    public void marshalJson(@NotNull Object object, @NotNull Writer writer)
            throws JAXBException {
    ...
    /**
     * Marshals the given {@link Object} into the given {@link Writer}, configuring the {@link Marshaller} with the given additional {@link Properties}.
     *
     * @param object
     *         The {@link Object} to marshall.
     * @param writer
     ...
     *         Additional {@link Properties} to configure the {@link Marshaller}
     * @throws JAXBException
     *         See {@link Marshaller#marshal(Object, Writer)}
     * @since 1.5.0
     */
    private void marshal(@NotNull Object object, @NotNull Writer writer, @NotNull Map<String, Object> additionalProperties) throws JAXBException {
     ...
     *
     * @param objectString
     *         The {@link String} serialized.
     * @param type
     *         The {@link Class} type to unmarshal to.
     * @return The unmarshalled {@link Object}.
     * @throws JAXBException
     *         See {@link #getContext()}.
     * @throws SAXException
     *         See {@link XMLReaderFactory#createXMLReader()}.
     * @since 1.0.0
     */
    public <T> T unmarshal(@NotNull String objectString, @NotNull Class<T> type)
     ...
     * @since 1.0.0
     */
    public <T> T unmarshal(@NotNull Reader reader, @NotNull Class<T> type)
            throws JAXBException, SAXException {
     ...
     *         The {@link Class} type to unmarshal to.
     * @param namespaceUri
     *         The namespace {@link java.net.URI} to use
     * @return The unmarshalled {@link Object}.
     * @throws JAXBException
     *         See {@link #getContext()}.
     * @throws SAXException
     ...
     * @since 1.0.0
     */
    public <T> T unmarshal(@NotNull String objectString, @NotNull Class<T> type, @Nullable String namespaceUri)
            throws JAXBException, SAXException {
        try (Reader reader = new StringReader(objectString)) {
     ...
     * @since 1.0.0
     */
    public <T> T unmarshal(@NotNull Reader reader, @NotNull Class<T> type, @Nullable String namespaceUri)
            throws JAXBException, SAXException {
     ...
     * @since 1.5.0
     */
    public <T> T unmarshalJson(@NotNull String objectString, @NotNull Class<T> type) throws JAXBException, SAXException {
        try (Reader reader = new StringReader(objectString)) {
     ...
     */
    @Deprecated
    public <T> T unmarshalJson(@NotNull String objectString, @NotNull Class<T> type, @Nullable String namespaceUri)
            throws JAXBException, SAXException {
        try (Reader reader = new StringReader(objectString)) {
     ...
     * @since 2.0.0
     */
    public <T> T unmarshalJson(@NotNull Reader reader, @NotNull Class<T> type)
            throws JAXBException, SAXException {
     ...
     * @since 1.0.0
     */
    public <T> T unmarshalJson(@NotNull Reader reader, @NotNull Class<T> type, @Nullable String namespaceUri)
            throws JAXBException, SAXException {
    ...
    /**
     * Unmarshals the given JSON {@link Reader} as the given {@link Class type} according to the given namespace {@link java.net.URI}, configuring the {@link Unmarshaller} with the given additional
     * {@link Properties}.
     *
     * @param reader
     *         The {@link Reader} serialized.
     ...
     *         The namespace {@link java.net.URI} to use
     * @param additionalProperties
     *         Additional {@link Properties} to configure the {@link Unmarshaller}
     * @param <T>
     *         The return {@link Class}
     * @return The unmarshalled {@link Object}.
     * @throws JAXBException
     *         See {@link #getContext()}.
     * @throws SAXException
     *         See {@link XMLReaderFactory#createXMLReader()}.
     */
    private <T> T unmarshal(@NotNull Reader reader, @NotNull Class<T> type, @Nullable String namespaceUri, @NotNull Map<String, Object> additionalProperties)
            throws JAXBException, SAXException {
        JAXBContext context = getContext();
