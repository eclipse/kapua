...
import org.eclipse.kapua.storage.KapuaEntityBareRepository;
...
public class KapuaEntityJpaBareRepository<E extends KapuaEntity, C extends E, L extends KapuaListResult<E>> implements KapuaEntityBareRepository<E, L> {
    ...
    public KapuaEntityJpaBareRepository(
    ...
    protected javax.persistence.EntityManager extractEntityManager(TxContext txContext) {
    ...
    public E delete(TxContext txContext, KapuaId scopeId, KapuaId entityId) throws KapuaException {
        ...
        return doDelete(txContext, entityToDelete);
    }

    @Override
    public E doDelete(TxContext txContext, E entityToDelete) {
        final javax.persistence.EntityManager em = extractEntityManager(txContext);
