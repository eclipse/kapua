 ...
 * @since 1.0
 */
public class KapuaServiceSchemaUtils {

    private static final Logger logger = LoggerFactory.getLogger(KapuaServiceSchemaUtils.class);

    private KapuaServiceSchemaUtils() {
    }
