...
public class KapuaNamedEntityJpaBareRepository<E extends KapuaNamedEntity, C extends E, L extends KapuaListResult<E>>
        extends KapuaUpdatableEntityJpaBareRepository<E, C, L>
        implements KapuaNamedEntityBareRepository<E, L> {
    public KapuaNamedEntityJpaBareRepository(Class<C> concreteClass, Supplier<L> listSupplier) {
        super(concreteClass, listSupplier);
    }

    @Override
    public E findByName(TxContext txContext, String name) throws KapuaException {
        final EntityManager em = this.extractEntityManager(txContext);
