...
public interface ServiceConfigTransactedRepository extends
        KapuaEntityTransactedRepository<ServiceConfig, ServiceConfigListResult>,
        KapuaUpdatableEntityTransactedRepository<ServiceConfig, ServiceConfigListResult> {
