 ...
 */
//TODO: FIXME: PRIORITY: promote from static utility to injectable collaborator
public class StaticKapuaCacheManager {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(StaticKapuaCacheManager.class);
    ...
    private StaticKapuaCacheManager() {
    }
