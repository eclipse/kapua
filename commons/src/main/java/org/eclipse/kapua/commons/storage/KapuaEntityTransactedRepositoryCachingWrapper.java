...
public class KapuaEntityTransactedRepositoryCachingWrapper<E extends KapuaEntity, L extends KapuaListResult<E>> implements KapuaEntityTransactedRepository<E, L> {
    protected final KapuaEntityTransactedRepository<E, L> wrapped;
    protected final EntityCache entityCache;

    public KapuaEntityTransactedRepositoryCachingWrapper(KapuaEntityTransactedRepository<E, L> wrapped, EntityCache entityCache) {
