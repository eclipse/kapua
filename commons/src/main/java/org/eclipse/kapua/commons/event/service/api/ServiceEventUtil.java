...
import org.eclipse.kapua.commons.event.service.internal.ServiceEventImpl;
...
public class ServiceEventUtil {
     ...
     */
    public static org.eclipse.kapua.service.event.ServiceEvent toServiceEventBus(ServiceEvent serviceEventEntity) throws KapuaIllegalArgumentException {
        org.eclipse.kapua.service.event.ServiceEvent newEvent = new org.eclipse.kapua.service.event.ServiceEvent();
     ...
     * {@link #mergeToEntity(ServiceEvent, org.eclipse.kapua.service.event.ServiceEvent)} method)
     *
     ...
     */
    public static ServiceEvent fromServiceEventBus(org.eclipse.kapua.service.event.ServiceEvent serviceEventBus) throws KapuaIllegalArgumentException {
     ...
     */
    public static ServiceEvent mergeToEntity(ServiceEvent serviceEventEntity, org.eclipse.kapua.service.event.ServiceEvent serviceEventBus) throws KapuaIllegalArgumentException {
        if (serviceEventEntity.getId() == null) {
            throw new KapuaIllegalArgumentException("id", null);
        }
    ...
    private static ServiceEvent mergeToEntityInternal(ServiceEvent serviceEventEntity, org.eclipse.kapua.service.event.ServiceEvent serviceEventBus) {
