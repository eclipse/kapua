...
public class KapuaNamedEntityTransactedRepositoryCachingWrapper<E extends KapuaNamedEntity, L extends KapuaListResult<E>>
        extends KapuaUpdatableEntityTransactedRepositoryCachingWrapper<E, L>
        implements KapuaNamedEntityTransactedRepository<E, L> {

    public KapuaNamedEntityTransactedRepositoryCachingWrapper(KapuaNamedEntityTransactedRepository<E, L> wrapped, NamedEntityCache entityCache) {
    ...
    private E doFindByName(KapuaId scopeId, String value) throws KapuaException {
        ...
        final E found = ((KapuaNamedEntityTransactedRepository<E, L>) wrapped).findByName(scopeId, value);
        return found;
    }
}
