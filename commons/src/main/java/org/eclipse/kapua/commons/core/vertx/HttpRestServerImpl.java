...
public class HttpRestServerImpl extends AbstractVerticle implements HttpRestServer {

    private static Logger logger = LoggerFactory.getLogger(HttpRestServerImpl.class);
