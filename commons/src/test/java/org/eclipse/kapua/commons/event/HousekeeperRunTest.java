...
public class HousekeeperRunTest {

    private static final Logger logger = LoggerFactory.getLogger(HousekeeperRunTest.class);
    ...
    public void setAndGetServiceNullTest() {
        ...
        Assert.assertNull("Null expected!", houseKeeperRun.getService());
    }
    ...
    public void setAndGetServiceTest() {
        ...
        for (String value : permittedValues) {
            ...
            Assert.assertEquals("Expected and actual values should be the same!", value, houseKeeperRun.getService());
        }
    }
    ...
    public void setAndGetLastRunOnNullTest() {
        ...
        Assert.assertNull("Null expected!", houseKeeperRun.getLastRunOn());
    }

    @Test
    public void setAndGetLastRunOnDateFormatTest() {
        houseKeeperRun.setLastRunOn(date);
        Assert.assertEquals("Expected and actual values should be the same!", houseKeeperRun.getLastRunOn(), date);
    }

    @Test
    public void setAndGetLastRunOnDateFormat1Test() {
        houseKeeperRun.setLastRunOn(date1);
        Assert.assertEquals("Expected and actual values should be the same!", houseKeeperRun.getLastRunOn(), date1);
    }

    @Test
    public void setAndGetLastRunOnDateFormat2Test() {
        houseKeeperRun.setLastRunOn(date2);
        Assert.assertEquals("Expected and actual values should be the same!", houseKeeperRun.getLastRunOn(), date2);
    }

    @Test
    public void setAndGetLastRunOnDateFormat3Test() {
        houseKeeperRun.setLastRunOn(date3);
        Assert.assertEquals("Expected and actual values should be the same!", houseKeeperRun.getLastRunOn(), date3);
    }

    @Test
    public void setAndGetLastRunOnDateFormat4Test() {
        houseKeeperRun.setLastRunOn(date4);
        Assert.assertEquals("Expected and actual values should be the same!", houseKeeperRun.getLastRunOn(), date4);
    }

    @Test
    public void setAndGetLastRunByNullTest() {
        houseKeeperRun.setLastRunBy(null);
        Assert.assertNull("Null expected!", houseKeeperRun.getLastRunBy());
    }
    ...
    public void setAndGetLastRunByTest() {
        ...
        for (String value : permittedValues) {
            ...
            Assert.assertEquals("Expected and actual values should be the same!", value, houseKeeperRun.getLastRunBy());
        }
    }
    ...
    public void setAndGetVersionNullTest() {
        ...
        Assert.assertNull("Null expected!", houseKeeperRun.getVersion());
    }
