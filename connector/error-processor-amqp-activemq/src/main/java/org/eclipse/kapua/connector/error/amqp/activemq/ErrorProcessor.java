...
public abstract class ErrorProcessor implements Processor<Message> {

    private static final Logger logger = LoggerFactory.getLogger(ErrorProcessor.class);

    private AmqpSender sender;

    public static ErrorProcessor getProcessorWithNoFilter(Vertx vertx, AmqpSender sender) {
        return new ErrorProcessor(vertx, sender) {
            @Override
    ...
    public ErrorProcessor(Vertx vertx, AmqpSender sender) {
        this.sender = sender;
    }
